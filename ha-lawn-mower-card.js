...
class HALawnMowerCard extends HTMLElement {
  ...
  static getStubConfig() {
    return {
      ...
      mower: "lawn_mower.th_poul_2",
      battery: "sensor.th_poul_battery_2",
      error: "sensor.th_poul_error_2",
      charging: "binary_sensor.th_poul_charging",
      connectivity: "binary_sensor.th_poul_mqtt",
      firmware: "update.th_poul_firmware",
      signal_strength: "sensor.th_poul_signal_strength",
      daily_progress: "sensor.th_poul_daily_progress_2",
      next_schedule: "sensor.th_poul_next_schedule",
      last_update: "sensor.th_poul_last_update_2",
      rain_sensor: "binary_sensor.th_poul_rain_sensor",
      rain_delay_remaining: "sensor.th_poul_rain_delay_remaining",
      battery_temperature: "sensor.th_poul_battery_temperature_2",
      battery_voltage: "sensor.th_poul_battery_voltage_2",
      battery_cycles_total: "sensor.th_poul_battery_charge_cycles_total",
      battery_cycles_since_reset: "sensor.th_poul_battery_charge_cycles_since_reset",
      blade_runtime_total: "sensor.th_poul_blade_runtime_total",
      blade_runtime_since_reset: "sensor.th_poul_blade_runtime_since_reset",
      distance_driven_total: "sensor.th_poul_distance_driven_total",
      mower_runtime_total: "sensor.th_poul_mower_runtime_total",
      zone: "select.th_poul_zone",
      auto_schedule_boost: "select.th_poul_auto_schedule_boost",
      auto_schedule_grass_type: "select.th_poul_auto_schedule_grass_type",
      auto_schedule_soil_type: "select.th_poul_auto_schedule_soil_type",
      rain_delay: "number.th_poul_rain_delay",
      time_extension: "number.th_poul_time_extension_2",
      torque: "number.th_poul_torque_2",
      lawn_size: "number.th_poul_lawn_size",
      lawn_perimeter: "number.th_poul_lawn_perimeter",
      auto_schedule: "switch.th_poul_auto_schedule",
      firmware_auto_update: "switch.th_poul_firmware_auto_update",
      party_mode: "switch.th_poul_party_mode_2",
      auto_schedule_irrigation: "switch.th_poul_auto_schedule_irrigation",
      auto_schedule_exclude_nights: "switch.th_poul_auto_schedule_exclude_nights",
      lock: "switch.th_poul_lock",
      acs: "switch.th_poul_acs_2",
      edge_cut: "button.th_poul_edge_cut",
      reset_blade_runtime: "button.th_poul_reset_blade_runtime",
      reset_battery_cycles: "button.th_poul_reset_battery_cycles",
    };
  }
  setConfig(config) {
